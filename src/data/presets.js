...
export const PRESETS = [
  ...
  {
    id: '5r',
    group: 'Photo print formats',
    label: '5R (5×7 in)',
    wmm: 121.92,
    hmm: 172.72,
    dpi: DPI,
    defaultBg: WHITE,
    notes: '5R photo format, adjusted to 4.8×6.8 in (0.2 in smaller in width and height). White background.',
    source: '5R photo format with printer-margin adjustment',
  },
  {
    id: '4r',
    group: 'Photo print formats',
    ...
    dpi: DPI,
    defaultBg: WHITE,
    notes: '4R photo format, adjusted to 3.8×5.8 in (0.2 in smaller in width and height). White background.',
    source: '4R photo format with printer-margin adjustment',
  },
  {
    id: '3r',
    group: 'Photo print formats',
    ...
    dpi: DPI,
    defaultBg: WHITE,
    notes: '3R photo format, adjusted to 3.3×4.8 in (0.2 in smaller in width and height). White background.',
    source: '3R photo format with printer-margin adjustment',
  },
  {
    id: 'a4-photo',
    group: 'Photo print formats',
    ...
    dpi: DPI,
    defaultBg: WHITE,
    notes: 'A4 format, adjusted to 204.92×291.92 mm (0.2 in smaller in width and height). White background.',
    source: 'A4 format with printer-margin adjustment',
  },
  {
    id: 'asa-loan',
    group: 'Square & inch formats',
