...
const ICONS = {
  ...
  cloud_upload: [
    ['path', {
      d: 'M7 18a4.5 4.5 0 0 1-.6-8.96A5.5 5.5 0 0 1 17.3 8.1 4 4 0 0 1 17 16.9',
      ...S,
    }],
    ['path', { d: 'M12 20v-8M9 15l3-3 3 3', ...S }],
  ],
  shield_check: [
    ['path', { d: 'M12 3l7 3v6c0 4.5-3 7.5-7 9-4-1.5-7-4.5-7-9V6l7-3z', ...S }],
    ['path', { d: 'M8.7 12.2l2.2 2.2 4.4-4.6', ...S }],
  ],
  sparkles: [
    ['path', { d: 'M6 3l.9 2 2 .9-2 .9-.9 2-.9-2-2-.9 2-.9z', ...F }],
    ['path', { d: 'M17 10.5l1.3 3 3 1.3-3 1.3-1.3 3-1.3-3-3-1.3 3-1.3z', ...F }],
    ['path', { d: 'M12.5 2l.8 1.8 1.8.8-1.8.8-.8 1.8-.8-1.8-1.8-.8 1.8-.8z', ...F }],
  ],
  person: [
  ...
  school: [
    ['path', { d: 'M12 3l10 5-10 5L2 8l10-5z', ...S }],
    ['path', { d: 'M6 11v5.5c0 1.1 2.7 2.5 6 2.5s6-1.4 6-2.5V11', ...S }],
    ['path', { d: 'M21 9v6.5', ...S }],
  ],
  grid_view: [
  ...
  fit_screen: [
    ['path', { d: 'M4 9V6a2 2 0 0 1 2-2h3M20 9V6a2 2 0 0 0-2-2h-3M4 15v3a2 2 0 0 0 2 2h3M20 15v3a2 2 0 0 1-2 2h-3', ...S }],
    ['rect', { x: 8, y: 9, width: 8, height: 6, rx: 1, ...S }],
  ],
  eraser: [
    ['path', { d: 'M18.5 13.5L9 22H4l-1.5-1.5a2 2 0 0 1 0-2.8L13 7.2a2 2 0 0 1 2.8 0l3.7 3.7a2 2 0 0 1 0 2.6z', ...S }],
    ['path', { d: 'M9 22l-5.5-5.5', ...S }],
  ],
  image: [
    ['rect', { x: 3, y: 4, width: 18, height: 16, rx: 2, ...S }],
    ['circle', { cx: 9, cy: 10, r: 1.8, ...S }],
    ['path', { d: 'M4.5 18.5l5-5 3 3 3.5-4 4.5 5', ...S }],
  ],
};
