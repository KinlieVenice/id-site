...
export const DEFAULT_HUE = 8; // vermilion studio accent
...
export function buildPalette(hue, mode) {
  ...
  const paperRgb = dark ? [29, 29, 26] : [246, 244, 237];
  ...
  return {
    ...
    '--paper-2': dark ? '#282824' : '#eae7de',
    '--ink': dark ? '#eeece5' : '#262722',
    '--ink-2': dark ? '#bcbcb0' : '#616258',
    '--ink-3': dark ? '#b0b0a5' : '#67685d',
    '--line': dark ? '#45453c' : '#d7d6cb',
    '--line-2': dark ? '#626255' : '#b9b9ac',
