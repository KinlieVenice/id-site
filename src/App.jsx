    ...
    <div className="game-shell">
      <header className="sidebar">
        <div className="sidebar-brand">
          <span className="brand-mark" aria-hidden="true"><Icon name="crop" /></span><span>ID Photo Maker</span>
        </div>
      ...
      <footer className="studio-footer"><span><Icon name="lock" /> Local processing</span><span>JPG / PNG · Print-ready output</span></footer>
    </div>
  );
}
